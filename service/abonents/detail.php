...
<tr><th>Услуга<th>Свитч<th>Порт<th>IP<th>MAC<th>Диагностика<th><i class='fa fa-pencil-square-o'  ></i></th></tr></thead><tbody>";
    while ($b = $bindings->fetch_assoc()) {
        ...
        <td><a href='?id={$form['id']}&checkPort={$b['id']}'>Проверить</a><br><a href='?id={$form['id']}&ping={$b['ip']}'>Пропинговать</a>
        <br><a target='_blank' href='/system/redirect-to-wildcore?binding_id={$b['id']}&type=to_dev_from_binding'>Свитчер</a>
        </td>
